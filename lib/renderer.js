...
Renderer.prototype.link = function(href, title, text){
  ...
  // console.log('marked > link > addBaseLink : ', href, this.options.baseLink);
...
Renderer.prototype.image = function(href, title, text){
  ...
  // console.log('marked > image > addBaseLink : ', href, this.options.baseLink);  
  href = addBaseLink(href, this.options.baseLink);
...
module.exports = function(data, options){
  ...
  if(!!this.config.post_asset_folder && options){
